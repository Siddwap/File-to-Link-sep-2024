    ...
    try {
        ...
        writer.on('finish', async () => {
            ...
            try {
                ...
                const photoUrl = 'https://graph.org/file/46b302d35bdbb4b1ae4b0.jpg'; // Your photo URL
...
bot.start(async (ctx) => {
    const photoUrl = 'https://graph.org/file/46b302d35bdbb4b1ae4b0.jpg'; // Photo URL
    ...
    await ctx.replyWithPhoto(photoUrl, {
        ...
        reply_markup: {
            inline_keyboard: [
                [
                    { text: '✨ Join Channel ✨', url: 'https://t.me/sdbots1' }
                ]
            ]
        }
    });
